...
<body>
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title"><a class="tjgk bq load" href="system/settings">系统设置</a><a class="tjgk bq load" href="business/betLog">普通投注</a><a class="tjgk bq load" href="member/index">用户列表</a><a class="tjgk bq load" onClick="rechargModal()" href="#" value="充值">账号充值</a><a class="tjgk bq load" method="post" target="ajax" call="clearDataSuccess" title="即将清空程序缓存，是否继续！" dataType="json" href="/qq836651666.php/clear/rmfile">清空缓存</a>
            </h2>
            <div class="btn_view_site"><a href="/qq1655707002.php/user/login">安全退出</a></div>
		</hgroup>
	</header>
	...
	<aside id="sidebar" class="column">
		<form action="/qq836651666.php/member/listUser" class="quick_search" call="searchUserSubmit" dataType="html" target="ajax">
		...
		<ul class="toggle" style="display:none;">
		<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ foreach($this->getRows("select id,title from {$this->prename}type where enable=1 and isDelete=0 order by sort") as $type){ ?>
...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ } ?>
		...
		<footer>
			<hr />
			<p><strong>Copyright &copy; 娱乐后台管理系统</strong></p>
		</footer>
	</aside><!-- end of sidebar -->

	<section id="message-tip"></section>
	<section id="main" class="column"><?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ $this->display('count/index.php'); ?></section>
</body>
</html>
