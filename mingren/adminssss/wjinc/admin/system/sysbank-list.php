...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($data['data']) foreach($data['data'] as $var){ ?>
			<tr>
				...
				<td><a href="/qq836651666.php/system/switchBankStatus2/<?=$var['id']?>" target="ajax" call="sysReloadBank"><?=$this->iff($var['enable'], '关闭', '开启')?></a> | <a href="#" onclick="sysEditBank(<?=$var['id']?>)">修改</a> | <a href="/qq836651666.php/system/deleteBank2/<?=$var['id']?>" target="ajax" call="sysReloadBank">删除</a></td>
			</tr>
		<?php
