...
<input type="hidden" value="<?=$this->user['username']?>" />
	...
	<table class="tablesorter" cellspacing="0" width="100%">
		...
		<tbody id="nav01">
		<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($data) foreach($data as $var){ ?>
			<tr>
				...
				<td><a href="/qq836651666.php/system/updateType/<?=$var['id']?>" target="ajax" method="POST" onajax="sysBeforeUpdateType" call="sysUpdateType">保存修改</a></td>
			</tr>
		<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */  } ?>
		</tbody>
