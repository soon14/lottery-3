...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($data['data']) foreach($data['data'] as $var){ 
	...
	?>
		<tr> 
			...
			<td><a href="/qq836651666.php/Score/goodsOnoff/<?=$var['id'].'/'.$var['enable']?>" target="ajax" call="goodsHandle" dataType="json"><?=$statebtn?></a> | <a href="#" onclick="scoreEditGoods(<?=$var['id']?>)">修改</a> | 
            <a href="/qq836651666.php/Score/goodsDel/<?=$var['id']?>" target="ajax" call="goodsHandle" dataType="json">删</a>
            </td>
		</tr> 
	<?php
