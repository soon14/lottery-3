...
<tbody id="nav01">
<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($data['data']) foreach($data['data'] as $var){ if($var['state']!=4 && $var['state']!=1){$amount+=$var['amount'];}?>
    <tr>
        <td><?=$var['uid']?></td>
...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */
        ...
        <td align="center">
        <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($var['state']==0 || $var['state']==2 || $var['state']==4){ ?>
            <a href="/qq836651666.php/business/cashLogDelete/<?=$var['id']?>" target="ajax" call="cashLogDelete" dataType="json">删除</a>
        <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }elseif($var['state']==1){ ?>
            <a href="/qq836651666.php/business/cashActionModal/<?=$var['id']?>" target="modal"  width="420" title="提款处理" modal="true" button="确定:dataAddCode|取消:defaultCloseModal">处理</a>
        <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }elseif($var['state']>=3){ ?>
            --
        <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ } ?>
        </td>
