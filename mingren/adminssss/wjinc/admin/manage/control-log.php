...
<input type="hidden" value="<?=$this->user['username']?>" />
	<header>
		...
		<form action="/qq836651666.php/manage/controlLogList" class="submit_link wz" target="ajax" dataType="html" onajax="adminLogBeforeSubmit" call="adminLogList">
    ...
    <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ $this->display("manage/control-log-list.php") ?>
    </div>
