...
<input type="hidden" value="<?=$this->user['username']?>" />
	<header><h3 class="tabs_involved">用户等级限额设置</h3>
        <!--div  class="submit_link wz">
            <a href="/qq836651666.php/member/addUserCount" target="modal"  width="420" title="添加用户限额" ><input type="button"  class="alt_btn" value="添加"/></a>
        </div-->
      </header>
...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($data) foreach($data as $level){ ?>
		<tr>
            ...
            <td><a href="/qq836651666.php/member/updateUserCount/<?=$level['id']?>" target="ajax" method="post" onajax="sysBeforeUpdateUserCount" call="reloadUserCount">保存修改</a> | <a href="/qq836651666.php/system/delUserCount/<?=$level['id']?>" target="ajax" call="sysReloadUserCount" title="是否删除？">删除</a></td>
		</tr>
	<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ } ?>
	</tbody>
