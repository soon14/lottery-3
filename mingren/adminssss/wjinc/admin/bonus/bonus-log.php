...
<article class="module width_full">
    <header>
		...
		<form action="/qq836651666.php/bonus/bonusLog" target="ajax" datatype="html" call="defaultSearch" class="submit_link wz">
...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */
        ...
        <td align="center">
        <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($var['bonusStatus']==1){ ?>
            	<a href="/qq836651666.php/bonus/bonusLogDelete/<?=$var['id']?>" target="ajax" call="bonusLogDelete" dataType="html">删除</a>
        <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }else{ ?>
				<a href="/qq836651666.php/bonus/bonusLogActionModal/<?=$var['id']?>" target="ajax" call="bonusLogModal">处理</a>
        <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ } ?>
        </td>
    </tr>
