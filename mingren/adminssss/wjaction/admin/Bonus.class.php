...
class Bonus extends AdminBase{
	...
	public function statLossAmount($uid,$fromTime,$toTime){
		...
		foreach($childUidarr as $child){
				...
				$childarr=$this->getRow("select sum(b.mode * b.beiShu * b.actionNum) betAmount, sum(b.bonus) zjAmount from ssc_members u left join ssc_bets b on u.uid=b.uid and b.isDelete=0 $betTimeWhere $childrenWhere");
