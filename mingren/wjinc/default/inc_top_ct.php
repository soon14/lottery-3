...
<body style="">
  <div class="content-warp">
	...
	<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
      <div class="list-group  text-center dw"><a  style=""class="ui-btn ui-btn-important w150" href="javascript:void(0);" id="msgForm:j_id3" name="msgForm:j_id3" onclick="qinyiUrlGo1('/index.php/cash/recharge',this)">在线充值</a><a class="ui-btn ui-btn-default w150" href="javascript:void(0);" id="msgForm:j_id4" name="msgForm:j_id4" onclick="qinyiUrlGo1('/index.php/cash/toCash',this)">提现申请</a><a style=""class="ui-btn ui-btn-default w150" href="javascript:void(0);" id="msgForm:j_id6" name="msgForm:j_id6" onclick="qinyiUrlGo1('/index.php/cash/rechargeLog',this)">充值记录</a><a class="ui-btn ui-btn-default w150" href="javascript:void(0);" id="msgForm:j_id5" name="msgForm:j_id5" onclick="qinyiUrlGo1('/index.php/cash/toCashLog',this)">提现记录</a>
					</div>
