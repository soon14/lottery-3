...
<div class="pagemain">
    <div class="display biao-cont">
 	<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($bank['bankId']){?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
    ...
    <strong style="color:green;font-size:16px;"><?=$this->settings['cashMin']?></strong>&nbsp;&nbsp;元，最大提提现&nbsp;&nbsp; 
    <strong style="color:green;font-size:16px;"><?=$this->settings['cashMax']?></strong>&nbsp;&nbsp;元。财付通/支付宝用户,最小提现&nbsp;&nbsp;<strong style="color:green;font-size:16px;"><?=$this->settings['cashMin1']?></strong>&nbsp;&nbsp;元，最大提现&nbsp;&nbsp;<strong style="color:green;font-size:16px;"><?=$this->settings['cashMax1']?></strong>&nbsp;&nbsp;元。
	</td> 
    </tr>
	<tr height=25 class='table_b_tr_b' >
      <td align="right" class="copys">今日消费：</td>
      <td align="left">今日投注：&nbsp;&nbsp;<?=$this->iff($cashAmout,$cashAmout,0)?> &nbsp;&nbsp;今天充值：&nbsp;&nbsp;<?=$this->iff($rechargeAmount,$rechargeAmount,0)?></td> 
    </tr>
	<tr height=25 class='table_b_tr_b' >
      <td align="right" class="copys">消费比例说明：</td>
      <td align="left"><p>计算公式：今日消费比例=今日投注量/今日充值额</p>
	                   <p>(消费比例未达到系统设置的&nbsp;&nbsp;<strong style="color:red" id="sysbili"><?=$this->settings['cashMinAmount']?></strong>&nbsp;&nbsp;%，则不能提款.)</p></td> 
    </tr>
	<tr height=25 class='table_b_tr_b' >
