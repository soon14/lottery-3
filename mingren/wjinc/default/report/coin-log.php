...
<table width="100%" class='table_b'>
	...
	<tbody class="table_b_tr">
		<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($list['data']) foreach($list['data'] as $var){ ?>
		<tr>
			<td><?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ echo substr(date('Y-m-d H:i:s', $var['actionTime']),2)?></td>
			<td style="display:none"><?=$var['username']?></td>
