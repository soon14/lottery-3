...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ } ?>
	...
	<div class="game-cont">
     <!--玩法--><?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ $this->display('index/inc_game_played.php'); ?>
...
<div class="c_betresult collect-static clearfix mt20" id="game-dom" >
	<div class="f-left fn-area">
		<!-- <span>投注数：1注 金额：2元</span> -->
		...
		<?php } ?>
	 	<div style=" margin-top:0px;float:right; margin-right:20px;">  
...
<div style='width:300px;float:right;margin:15px 20px 15px 0;' id='historylot'>
        <?php
/* 此程序来自家园网络QQ1655707002 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */  $this->display('index/inc_data_history.php'); ?>
        </div>
