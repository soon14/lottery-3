...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */
		...
		<tr>
			...
			<td><em>中奖金额：</em><span class="red"><?=$this->iff($bet['lotteryNo'], number_format($bet['bonus'] - ($bet['fanDian']/100)*$betCont, 2) .'元', '－')?></span></td>
		</tr>
         <tr>
			<td colspan="4"><em>购买盈亏：￥&nbsp</em><em class="green">
			<?=$this->iff($bet['lotteryNo'], number_format($bet['bonus'] - $betCont, 2), '－')?></em> 元<em class="green">&nbsp(
			<?=$this->iff($bet['lotteryNo'], $this->iff(number_format($bet['bonus'] - $betCont, 2)>=0,"赢","亏"), '－')?>)</em></td>
		</tr>
        <tr class="nobd">
