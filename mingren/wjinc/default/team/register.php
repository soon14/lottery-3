...
<head lang="en">
	<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ $this->display('inc_base_lr.php',0,'用户注册') ?>
...
<div class="w1200 clearfix">
    <div class="fl register-main">
        ...
        <div class="registerBox clearfix">
         ...
         <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($args[0] && $args[1]){
		...
		<form action="/index.php/user/registered" method="post" onajax="registerBeforSubmit" enter="true" call="registerSubmit" target="ajax">
            ...
            <input type="hidden" name="lid" value="<?=$linkData['lid']?>"  />
                ...
                <div class="pr ui-form-item mt">
                    <i class="ico-pw"></i>
                    <i class="ico-jp"></i>
                    <input class="ui-input" type="password" name="cpasswd" maxlength="16" id="cpasswd" placeholder="请再次输入您的密码" data-explain="请再次输入密码" />
...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }else{?>
           <div style="font-size:20px; color:#999999"><b>该代理注册链接已失效！可联系客服或前往BOECP首页自主注册！
		   <br/><br/>
		   <span style="margin-left:190px">感谢您对BOECP的支持！</span>
		   <br/><br/>
		   <span style="margin-left:150px">BOECP将提供更好更优质的服务！</span>
		   <br/><br/>
		   <a href="#" style="margin-left:180px" title="BOECP首页">http://158mryy.com</a></b>
		   </div>
           <?php
...
<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ $this->display('inc_footer.php') ?>
</body>
</html>