...
$pMerBillNo = $_POST["Billno"];//商户订单号 
$pAmount = sprintf("%0.02f",$_POST["Amount"]);//订单金额 
$pDate = date("Ymd");//订单日期
$pCurrencyType = "156";//币种
$pGatewayType = "01";//支付方式
$pLang = "GB";//语言
$pMerchanturl = "http://".$_SERVER['SERVER_NAME']."/ipspay/p2p_url.php";//支付结果成功返回的商户URL 
$pFailUrl = "";//支付结果失败返回的商户URL 
$pAttach = $_POST["Attach"];//商户数据包
$pOrderEncodeTyp = '5';//订单支付接口加密方式 默认为5#md5
$pRetEncodeType = '17';//交易返回接口加密方式
$pRetType = '1';//返回方式 
$pServerUrl = "http://".$_SERVER['SERVER_NAME']."/ipspay/s2s_url.php";//Server to Server返回页面 
$pBillEXP = 1;//订单有效期(过期时间设置为1小时)
$pGoodsName = "名人在线充值";//商品名称
$pIsCredit = '0';//直连选项
$pBankCode = "";//银行号
$pProductType= '1';//产品类型
