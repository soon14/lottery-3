...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
	...
	<tr height=25 class='table_b_tr_b' >
      ...
      <td align="left" >
	  <p>每天的充值处理时间为：<b style="display:inline;color:#FF0000;">早上 &nbsp 9:00 &nbsp 至  次日凌晨 &nbsp 00:00</b>（在线网银充值则为24小时不间断）</p>
	  <p></p>
	  <p>充值后，<b style="display:inline;color:#FF0000;">请手动刷新&nbsp&nbsp</b>你的余额及查看相关账变信息，若超过5分钟未加金额，请于在线客服联系</p>
	  <p></p>
...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ } ?>
    ...
    <tr height=25 class='table_b_tr_b' id="display-dom">
      <td align="center" class="copys" height="30">银行类型：</td>
