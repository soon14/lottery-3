...
<head>
<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ $this->display('inc_skin.php', 0 , '活动中心'); ?>
...
<div class="content3 wjcont">
 <div class="body">
    ...
    <div class="con_chouj">
        <div class="con_width chouj_content clearfix" id="lottery_content_box" style="width:990px;">
...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ 
 	               ...
 	               <h3 style="font-size:15px">&nbsp&nbsp抽奖活动说明：</h3>
                     <ul>
                        <span class="scoreinfo"><?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ $this->display('score/reloadscore.php');?></span>
