<div class="incgameright" style="background-color:#fff;overflow:hidden;">
	<div style="width:1050px;float:left;padding-left:20px;">
		<div class="jspContainer" style="width: 1050px; height: 35px;">
			<div class="jspPane" style="padding: 0px 10px; top: 0px; left: 0px; width: 1030px;">
				<table class="table table-info fs-12 text-center">
				...
				<table id="lt_cf_content" class="table table-info fs-12 text-center"style="width:1030px;">

				</table>
				<ul id="J-balls-order-container" class="result-ball-panel clearfix"></ul>
			</div>
		</div>
		<div class="codeList clearfix" style="padding:0 10px;">
			<ul class="touzhu-cont" style="border:0px;"><table></table></ul>
		</div>
	</div>
	<div style="width:1100px;">
		<div class="jixuanBox clearfix"style="float:left;">
			<ul>
				...
				<li class="jb-btn-03"><a href="javascript:void(0)" >快速投注</a></li>
			</ul>  
		</div>
		<div style="float:right;margin-right:20px;margin-bottom:25px;">
		...
		<div class="betSubmit danwei clearfix"  style="float:left;width:250px;">
			<span class="tz-tongji fs14" style=" display:block; height:20px; width:100%;  color:#333; margin-top:10px; float:left;padding-left:50px;">总投注数：<strong class="fe0" id="all-count" style="color:#ea5635">0</strong>注，总金额：￥<strong class="fe0" id="all-amount" style="color:#ea5635;">0.00</strong>元</span>
			<div></div>
