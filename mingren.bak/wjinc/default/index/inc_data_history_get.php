...
<tr align=center>
    <td>
        <div class='periodlist'><?= substr($var['number'],-3)?></div>
    </td>
    <td title='<?=$var['data']?>'>
        <div class='periodlist'><?php  foreach($udata as $num){ echo "<span>".$num."</span>";} ?></div>
    </td>
</tr> 
...
<tr align=center>
  ...
  <td title='<?=$udata?>'><div class='periodlist'><?php  foreach($udata as $num){ echo "<span>".$num."</span>";} ?></div></td>
</tr> 
