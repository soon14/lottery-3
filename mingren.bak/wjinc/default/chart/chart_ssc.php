...
/* 此程序来自家园网络QQ836651666 采集修复 程序修复 程序仅供学习交流使用 禁止用于商业和非法用途 */ 
	$type=intval($_GET['type']);
	$count=intval($_GET['count']);
	$this->getTypes();
	//echo $count;
?>
	<title><?=$this->settings['webName'] ?>-查看历史号码</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<meta http-equiv="Pragma" content="no-cache" />
	<style>
		font,div,td{font-size:12px;}
	</style>
	<link rel="stylesheet" href="/skin/chart/css/line.css" type="text/css" />
	<script language="javascript" type="text/javascript" src="/skin/chart/js/jquery.js"></script>
	<script language="javascript" type="text/javascript" src="/skin/chart/js/line.js"></script>
	<script language="javascript" type="text/javascript" src="/skin/chart/js/calendar/jquery.dyndatetime.js"></script>
	<script language="javascript" type="text/javascript" src="/skin/chart/js/calendar/lang/calendar-utf8.js"></script>
	<link rel="stylesheet" href="/skin/chart/js/calendar/css/calendar-win2k-cold-1.css" type="text/css" />
	<style type="text/css">
			...
			<div class="search">
				...
				<table width="100%" id="titlemessage" border="0" cellpadding="0" cellspacing="0" style="background:#DDE0E5;">
					<tr>
						...
						<td>
							<a href="/index.php/chartssc?type=<?=$type ?>&count=30">最近30期</a>
							<a href="/index.php/chartssc?type=<?=$type ?>&count=50">最近50期</a>
							<a href="/index.php/chartssc?type=<?=$type ?>&count=100">最近100期</a>
							<a href="/index.php/chartssc?type=<?=$type ?>&count=300">最近300期</a>
							<a href="/index.php/chartssc?type=<?=$type ?>&count=500">最近500期</a>
							<a href="/index.php/chartssc?type=<?=$type ?>&count=1000">最近1000期</a>
						</td>
						<!-- td>
							<form method="post">
