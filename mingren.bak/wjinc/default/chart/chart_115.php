			...
			<div class="search">
				...
				<table width="100%" id="titlemessage" border="0" cellpadding="0" cellspacing="0" style="background:#DDE0E5;">
					<tr>
						...
						<td>
							<a href="/index.php/chart115?type=<?=$type ?>&count=30">最近30期</a>
							<a href="/index.php/chart115?type=<?=$type ?>&count=50">最近50期</a>
							<a href="/index.php/chart115?type=<?=$type ?>&count=100">最近100期</a>
							<a href="/index.php/chart115?type=<?=$type ?>&count=300">最近300期</a>
							<a href="/index.php/chart115?type=<?=$type ?>&count=500">最近500期</a>
							<a href="/index.php/chart115?type=<?=$type ?>&count=1000">最近1000期</a>
						</td>
						<!-- td>
							<form method="post">
