...
<body style="">
  <div class="content-warp">
	...
	<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
	  ...
	  <a class="ui-btn ui-btn-default w150" href="javascript:void(0);" id="msgForm:j_id4" name="msgForm:j_id4" onclick="qinyiUrlGo1('/index.php/safe/info',this)">个人信息</a><a style=""class="ui-btn ui-btn-default w150" href="javascript:void(0);" id="msgForm:j_id6" name="msgForm:j_id6" onclick="qinyiUrlGo1('/index.php/safe/infotop',this)">我的银行卡</a><a class="ui-btn ui-btn-default w150" href="javascript:void(0);" id="msgForm:j_id5" name="msgForm:j_id5" onclick="qinyiUrlGo1('/index.php/safe/passwd',this)">密码修改</a>
					</div>
