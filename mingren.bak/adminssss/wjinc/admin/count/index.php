...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */
	...
	?>
	<article class="stats_overview" style="margin:13px auto auto 80px; width:20%; float:left;">
        <table align="center" style="text-align:center">
            ...
            <tbody>
			<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ for($i=0;$i<($arrId+1);$i++){?>
            <tr>
