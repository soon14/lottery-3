...
<body>
<form name="system_addBank" action="/qq836651666.php/system/updateBank2" enctype="multipart/form-data" method="POST">
<?php
	...
	<tbody>
		<tr> 
			...
			<td>
				<select name="bankId">
				<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($banks) foreach($banks as $var){ ?>
