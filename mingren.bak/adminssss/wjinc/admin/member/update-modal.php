...
<form action="/qq836651666.php/member/userUpdateed" target="ajax" method="post" call="userDataSubmitCode" onajax="userDataBeforeSubmitCode" dataType="html">
	...
	<table cellpadding="2" cellspacing="2" class="popupModal">
        ...
        <tr>
            ...
            <td><label><input type="radio" value="1" name="enable" <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($userData['enable']) echo 'checked="checked"'?>/>开启</label>&nbsp;&nbsp;<label><input type="radio" value="0" name="enable" <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if(!$userData['enable']) echo 'checked="checked"'?>/>冻结</label></td>
        </tr>
		<tr>
        ...
        <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($userData['qq']){?>
        <tr>
