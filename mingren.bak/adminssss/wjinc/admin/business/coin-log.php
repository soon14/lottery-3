...
<input type="hidden" value="<?=$this->user['username']?>" />
	<header>
		...
		<form action="/qq836651666.php/business/coinLog" class="submit_link wz" target="ajax" call="defaultSearch" dataType="html">
			...
			<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($this->types) foreach($this->types as $var){
...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($data['data']) foreach($data['data'] as $var){
	...
	?>
		<tr>
			...
			<td><?=$var['info']?></td>
            <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($var['extfield0'] && in_array($var['liqType'], array(2,3,4,5,6,7,10,11,100,101,102,103,104,105,108))){ ?>
                <td><a target="modal" button="关闭:defaultCloseModal" width="510" title="投注信息" href="/qq836651666.php/business/betInfo/<?=$var['extfield0']?>"><?=$this->ifs($var['extfield0'], '--')?></a>
                </td>
			...
			<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }elseif(in_array($var['liqType'], array(1,9,52))){?>
                <td><a href="/qq836651666.php/business/rechargeInfo/<?=$var['extfield0']?>" width="500" title="充值信息" button="关闭:defaultCloseModal" target="modal"><?=$var['extfield1']?></a></td>
                <td>--</td>
                <td>--</td>
                <td>--</td>
                <td>--</td>
			<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }elseif(in_array($var['liqType'], array(8,106,107))){?>
                <td><a href="/qq836651666.php/business/cashInfo/<?=$var['extfield0']?>" width="500" title="提现信息" button="关闭:defaultCloseModal" target="modal"><?=$var['extfield0']?></a></td>
                <td>--</td>
                <td>--</td>
                <td>--</td>
                <td>--</td>
