    ...
    <header>
    	<h3 class="tabs_involved">兑换订单
            <div class="submit_link wz">
            	<form action="/qq836651666.php/Score/pointList" target="ajax" call="defaultSearch" dataType="html">
...
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($data['data']) foreach($data['data'] as $var){
		...
		<tr> 
			...
			<td><span class="state spn4 <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($state=="完成") echo 'spn5'?> <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if(!$var['enable']) echo 'spn6'?>"><?=$state?></span></td> 
			<td>
            	<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($state!="完成"&&$var['enable']){?><a href="/qq836651666.php/Score/pointState/<?=$var['id']?>/<?=$var['state']?>" target="ajax" call="pointHandle" dataType="json"><?=$statenext?></a> | <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }?>
                
				<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ if($statenext!="【完成】"&&$state!="完成"){
					if($var['enable']){?>
                <a href="/qq836651666.php/Score/pointEnable/<?=$var['id']?>/<?=$var['enable']?>" target="ajax" call="pointHandle" dataType="json">取消</a> |
				<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }else{?>
                <a href="/qq836651666.php/Score/pointEnable/<?=$var['id']?>/<?=$var['enable']?>" target="ajax" call="pointHandle" dataType="json">重启</a> |
                <?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }
				}?>
                
                <a href="/qq836651666.php/Score/pointDel/<?=$var['id']?>" target="ajax" call="pointHandle" dataType="json">删除</a>
            </td> 
		</tr>
		<?php
/* 此程序来自家园网络QQ836651666 采集修复 程序修改 仅供研究学习之用 禁止用于商业非法用途 */ }else{ ?>
