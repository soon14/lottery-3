...
属性：
	...
	$orderid
		请求发起方自己的订单号，该订单号将作为993  财付通的返回数据
	$callbackurl
		在下行过程中返回结果的地址，需要以http://开头
	$hrefbackurl
		支付完成之后993  财付通会自动跳转回到的页面
	$key
		商户密钥
...
class bankpay{
	...
	* 993  财付通网银支付接口URL
	*/
	const shunfoo_bank_url	= 'http://interface.shunfoo.com/Bank/';
	...
	*/
	public function send(){
		...
		//最终url
		$url	= bankpay::shunfoo_bank_url . "?" . $url . "&sign=" .$sign. "&hrefbackurl=". $this->hrefbackurl;				
